...
img_Del.src = "images/cast/btn_del_small_gif";
img_Close.src = "images/cast/btn_close_small_gif";
...
function spiffyCalManager() {
	...
	this.matchedFormat="";
	this.DefBtnImgPath = 'images/cast/';
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, leftright, displayTop, intBtnMode) {
...
// set year range for the calendar control
	this.minYearChoice=dteToday.getFullYear()-60;																		//dteToday.getFullYear();
	this.maxYearChoice=	dteToday.getFullYear()+44;																						//dteToday.getFullYear() + 5;
	//this.minYearChoice=dteToday.getFullYear()-87;
	...
	function makeCalendar(intWhatMonth,intWhatYear,bViewOnly) {
		...
		if (!(bViewOnly)) {
			strOutput += '<td class="cal-WeekDay" align="center" width="100%"><a href="javascript:'+this.varName+'.clearDay();"><img title="Click to clear off already selected date." name="calbtn1" src="'+strDefBtnImgPath+'btn_del_small.gif" border="0" width="10" height="12"></a>&nbsp;&nbsp;&nbsp;&nbsp;<SELECT class="cal-ComboBox" NAME="cboMonth" onChange="'+this.varName+'.changeMonth();">';
			...
			strOutput += '<\/SELECT>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:'+this.varName+'.hide();"><img title="Click to close the calendar." name="calbtn2" src="'+strDefBtnImgPath+'btn_close_small.gif" border="0" width="10" height="12"></a><\/td><\/tr><tr><td width="100%" align="center">';
		}
		else {
		...
		strOutput += '<table width="185" cellspacing="2" cellpadding="2" border="0"><tr>';
	...
	function writeControl(tab) {
		...
		strHold='<input class="cal-TextBox" ="'+tab+'" type="text" " readonly name="' + this.textBoxName + '" id="' + this.textBoxName + '"' + strTemp + 'size="12"  maxlength="10" value="' + this.getSelectedDate() + '"  onClick="';
		//alert(this.varName);">
...
//		strHold+=this.varName+'.show();return false;">';
		...
		strHold+='<img title="Click to open the calendar control. " align="absmiddle" border="0" name="' + this.btnName + '" src="' + strBtnImg +'" width="'+ strBtnW +'" height="'+ strBtnH +'" style="padding-bottom:9px;"></a>';
...
// put these next 2 lines in when the tiny cal btns seem to randomly disappear		
	...
	function changeDay(intWhatDay) {
		...
		this.textBox().value=eval(document.forms["spiffyCal"].cboMonth.options[document.forms["spiffyCal"].cboMonth.selectedIndex].value)+1+'-'+intWhatDay+'-'+document.forms["spiffyCal"].cboYear.options[document.forms["spiffyCal"].cboYear.selectedIndex].value;//calMgr.scFormatDate(dteCur,this.dateFormat);
		this.hide();
...
function domlay(id,trigger,lax,lay,content) {
	 ...
	 * from a script by Reyn poste	 d in the DHTML
